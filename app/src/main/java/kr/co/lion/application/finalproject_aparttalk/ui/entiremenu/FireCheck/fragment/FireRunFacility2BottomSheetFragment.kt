...
class FireRunFacility2BottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private var _binding: FragmentFireRunFacility2BottomSheetBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        _binding = FragmentFireRunFacility2BottomSheetBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fireCheckViewModel.fireCheckData.observe(viewLifecycleOwner) { data ->
            ...
            if(data.isNotEmpty()) {
                ...
                binding.textViewFireRunFacility2Mean.text = fireCheckViewModel.FireCheckRunFacility2Mean.replace("\\n", "\n")
                binding.textViewFireRunFacility2Content.text = fireCheckViewModel.FireCheckRunFacility2Content.replace("\\n", "\n")
            }
        }

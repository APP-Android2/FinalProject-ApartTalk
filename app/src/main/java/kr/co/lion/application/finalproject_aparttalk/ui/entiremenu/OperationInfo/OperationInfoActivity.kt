...
class OperationInfoActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name: AptOperationInfoFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            AptOperationInfoFragmentName.OPERATION_FIRST_FRAGMENT -> {
                newFragment = OperationFirstFragment()
            }
            AptOperationInfoFragmentName.OPERATION_SECOND_FRAGMENT -> {
                newFragment = OperationSecondFragment()
            }
        }
    ...
    fun removeFragment(name:AptOperationInfoFragmentName){
        SystemClock.sleep(200)

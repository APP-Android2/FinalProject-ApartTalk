...
class SafetyManagementFragment : Fragment() {
    ...
    private fun observeViewModel() {
        viewModel.filteredList.observe(viewLifecycleOwner) { list ->
            (fragmentSafetyManagementBinding.recyclerViewSafetyManagement.adapter as OperationSecondRecyclerView).updateList(list)
        }

        viewModel.getOperationInfoList()
        viewModel.filterOperationInfoList("SafetyManagement")
    }
}
...
class FireEtcFacility2BottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private var _binding: FragmentFireEtcFacility2BottomSheetBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        _binding = FragmentFireEtcFacility2BottomSheetBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fireCheckViewModel.fireCheckData.observe(viewLifecycleOwner) { data ->
            ...
            if(data.isNotEmpty()) {
                ...
                binding.textViewFireEtcFacility2Mean.text = fireCheckViewModel.FireCheckEtcFacility2Mean.replace("\\n", "\n")
                binding.textViewFireEtcFacility2Content.text = fireCheckViewModel.FireCheckEtcFacilityt2Content.replace("\\n", "\n")
            }
        }

...
class ServiceActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name: ServiceFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            ServiceFragmentName.SERVICE_FRAGMENT -> {
                newFragment = ServiceFragment()
            }
            ServiceFragmentName.SINGLE_SERVICE_FRAGMENT -> {
                newFragment = SingleServiceFragment()
            }
            ServiceFragmentName.VIEW_MY_Q_FRAGMENT -> {
                newFragment = ViewMyQFragment()
            }
            ServiceFragmentName.F_A_Q_FRAGMENT -> {
                newFragment = FAQFragment()
            }
            ServiceFragmentName.MY_Q_FRAGMENT -> {
                newFragment = MyQFragment()
            }
            ServiceFragmentName.ANNOUNCEMENT_FRAGMENT ->{
                newFragment = AnnouncementFragment()
            }
            ServiceFragmentName.VIEW_ANNOUNCEMENT_FRAGMENT -> {
                newFragment = ViewAnnouncementFragment()
            }

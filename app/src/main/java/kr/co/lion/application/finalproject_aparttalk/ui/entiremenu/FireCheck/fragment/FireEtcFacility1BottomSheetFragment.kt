...
class FireEtcFacility1BottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private var _binding: FragmentFireEtcFacility1BottomSheetBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        _binding = FragmentFireEtcFacility1BottomSheetBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fireCheckViewModel.fireCheckData.observe(viewLifecycleOwner) { data ->
            ...
            if(data.isNotEmpty()) {
                ...
                binding.textViewFireEtcFacility1Mean.text = fireCheckViewModel.FireCheckEtcFacility1Mean.replace("\\n", "\n")
                binding.textViewFireEtcFacility1Content.text = fireCheckViewModel.FireCheckEtcFacility1Content.replace("\\n", "\n")
            }
        }

...
class MyWriteActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name: MyWriteFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            MyWriteFragmentName.MY_WRITE_FRAGMENT -> {
                newFragment = MyWriteFragment()
            }
            MyWriteFragmentName.MY_WROTE_FRAGMENT -> {
                newFragment = MyWroteFragment()
            }
            MyWriteFragmentName.MY_LIKE_FRAGMENT -> {
                newFragment = MyLikeFragment()
            }
        }

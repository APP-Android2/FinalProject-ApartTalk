package kr.co.lion.application.finalproject_aparttalk.ui.broadcast.activity
...
import kr.co.lion.application.finalproject_aparttalk.databinding.ActivityBroadcastBinding
import kr.co.lion.application.finalproject_aparttalk.ui.broadcast.fragment.BroadcastDetailFragment
import kr.co.lion.application.finalproject_aparttalk.ui.broadcast.fragment.BroadcastFragment
...
class BroadcastActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityBroadcastBinding = ActivityBroadcastBinding.inflate(layoutInflater)
        ...
        replaceFragment(fragmentName as BroadcastFragmentName, false, true, bundle)
    }

    fun replaceFragment(name: BroadcastFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            // 안내 방송 리스트
            BroadcastFragmentName.BROADCAST_FRAGMENT -> {
        ...
        if(newFragment != null){
            ...
            fragmentTransaction.replace(R.id.containerBroadcast, newFragment!!)
    ...
    fun removeFragment(name: BroadcastFragmentName){

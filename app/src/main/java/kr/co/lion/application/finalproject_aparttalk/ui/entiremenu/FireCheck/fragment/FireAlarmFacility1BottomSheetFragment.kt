...
class FireAlarmFacility1BottomSheetFragment : BottomSheetDialogFragment() {

    private var _binding: FragmentFireAlarmFacility1BottomSheetBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        _binding = FragmentFireAlarmFacility1BottomSheetBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fireCheckViewModel.fireCheckData.observe(viewLifecycleOwner) { data ->
            ...
            if(data.isNotEmpty()) {
                ...
                binding.textViewFireAlarmFacility1Mean.text = fireCheckViewModel.FireCheckAlarmFacility1Mean.replace("\\n", "\n")
                binding.textViewFireAlarmFacility1Content.text = fireCheckViewModel.FireCheckAlarmFacility1Content.replace("\\n", "\n")
            }
        }
